...
@app.route('/user')
def user():
    #User(user_id=1, first_name='Dhanusha', last_name='Agarwal', email='dhanusha@uta.com', password='abc123').save()
    #User(user_id=2, first_name='Asmi', last_name='Gandhi', email='asmi@uta.com', password='abc123').save()
